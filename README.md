...
<html>
  ...
  <body>
    ...
    <figure> <iframe src="categories.html" width = "100%" height = "500px"></iframe> <figure>
      ...
      <p>
        NOTE: Sporadic voters make up the highest proportion of the data, so they make up a majority of the education and income levels. Thus, “rarely” 
        and “always” voting categories are better indicators of income and education.
      </p>
